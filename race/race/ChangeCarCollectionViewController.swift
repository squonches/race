...
//  race
//
//  Created by Баландина Александра Викторовна on 3/3/2023.
//
...
class ChangeCarCollectionViewController: UICollectionViewController {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! ChangeCarCollectionViewCel
